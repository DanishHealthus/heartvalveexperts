...
export default function WhyChooseHVEDan() {
    const [activeId, setActiveId] = useState(1);

    return (
        <section id="mainscroll" className="text-white relative animate-gradient-circle overflow-hidden">
                        ...
                        <div className="space-y-4">
                            {procedures.map((item) => (
                                <div
                                    ...
                                    className={`cursor-pointer hover:rounded-xl p-4 border-b hover:border border-gray-400 transition-colors ${activeId === item.id ? "bg-white/10" : "hover:bg-white/5"
                                        }`}
                                >
