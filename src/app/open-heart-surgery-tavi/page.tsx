  ...
  const faqData = [
    {
      id: 1,
      question:
        "Is Transcatheter Aortic Valve Implantation (TAVI) suitable for everyone who has been advised valve surgery?",
      answer:
    ...
    },
    {
      id: 3,
      question:
        "How do I know if I am a candidate for a catheter-based procedure?",
      answer:
    ...
    },
    {
      id: 5,
      question:
        "Can I get a second opinion at Heart Valve Experts if I have already been advised surgery elsewhere?",
      answer:
  ...
  return (
    <>
      ...
      <WhoIsThisTreatmentFor
        ...
        whyDescription="Procedures like Transcatheter Aortic Valve Implantation (TAVI) and MitraClip allow specialist teams to treat the valve through a small entry point typically through the groin — without a large incision. For the right patient, this can mean:"
      />
      <section className="animate-gradient-circle-aalekh text-white relative overflow-hidden">
          ...
          specialists={[
            {
              ...
              qualifications:
                "M.D., D.M. (Cardiology), FSCAI, Interventional Cardiologist, Transcatheter Aortic Valve Implantation (TAVI) and Structural Heart Specialist",
            ...
            },
            {
              ...
              qualifications:
                "M.D. (Internal Medicine), D.M., D.N.B. (Cardiology), AFESC, Cardiac Surgeon in Mumbai, Transcatheter Aortic Valve Implantation (TAVI) & Structural Heart Specialist",
        ...
        <WhoIsThisTreatmentFor3
          ...
          bullets={[
            {
              id: 1,
              text: "Review of your existing cardiac reports and imaging",
            },
            { id: 2, text: "Advanced 3D echo and CT imaging if required" },
            { id: 3, text: "Multidisciplinary team case discussion" },
            {
              id: 4,
              text: "Clear explanation of all suitable treatment options",
            },
            {
              id: 5,
              text: "Recommendation with full reasoning at your consultation",
            },
          ]}
