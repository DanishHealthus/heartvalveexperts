...
export async function POST(req) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: "heartvalveexperts@gmail.com, sahil@healthus.ai, shwetha@healthus.ai, mohit@healthus.ai,info@healthus.ai ,drankurmd@gmail.com, customerservicemanager@hvshospitals.in",
