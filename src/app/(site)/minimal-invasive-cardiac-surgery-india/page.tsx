...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Heart Valve Experts evaluates patients for advanced procedures including Transcatheter Aortic Valve Implantation (TAVI), Transcatheter Edge-to-Edge Repair (TEER), and Transcatheter Mitral Valve Repair (TMVR) at specialised cardiac facilities in Mumbai and Pune. An initial consultation is the first step to determining suitability.",
  },
];
