...
const faqData = [
  {
    id: 1,
    question:
      "Is Transcatheter Aortic Valve Implantation (TAVI) available in Mumbai?",
    answer:
      "Yes. Transcatheter Aortic Valve Implantation (TAVI) in Mumbai is available at advanced cardiac centres with dedicated structural heart programmes.",
  },
  {
    id: 2,
    question: "How long does the TAVR procedure take?",
    answer: "The procedure typically takes 1–2 hours.",
  },
  {
    id: 3,
    question:
      "Who is the best Transcatheter Aortic Valve Implantation (TAVI) surgeon in Mumbai?",
    answer: `An experienced structural <a target="_blank" href="https://heartvalveexperts.com/cardiologist-mumbai" class="text-blue-600 underline"> heart specialist </a> trained in transcatheter valve therapies with access to advanced imaging and cath lab infrastructure.`,
  },
  {
    id: 4,
    question:
      "What is the hospital stay after Transcatheter Aortic Valve Implantation (TAVI) surgery in Mumbai?",
    answer: "Most patients stay for 3–5 days depending on recovery.",
  },
  {
    id: 5,
    question:
      "Is Transcatheter Aortic Valve Implantation (TAVI) covered by insurance in Maharashtra?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "How long does a Transcatheter Aortic Valve Implantation (TAVI) valve last?",
    answer:
  ...
  },
  {
    id: 9,
    question:
      "How do I find a Transcatheter Aortic Valve Implantation (TAVI) specialist near me?",
    answer:
      "Search for a centre with an experienced structural heart team, advanced imaging facilities, and a dedicated Transcatheter Aortic Valve Implantation (TAVI) programme. Heart Valve Experts in Mumbai offer comprehensive evaluation and treatment for Transcatheter Aortic Valve Implantation (TAVI) patients.",
  },
];
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "MedicalProcedure",
  name: "Transcatheter Aortic Valve Implantation (TAVI) in Mumbai – Advanced Minimally Invasive Aortic Valve Replacement",
  description:
    "Transcatheter Aortic Valve Implantation (TAVI) in Mumbai offers a minimally invasive alternative to traditional open-heart valve replacement surgery and is widely used for patients who are elderly or considered high surgical risk.",
    ...
    <>
      ...
      <section className="text-white relative animate-gradient-circle overflow-hidden">
        <div className="max-w-7xl mx-auto text-white py-14 overflow-hidden">
          <FollowUpSection
            tag="Why Choose Us"
            title="Why Choose Heart Valve Experts for Transcatheter Aortic Valve Implantation (TAVI) in Mumbai?"
            intro="When evaluating options for the best Transcatheter Aortic Valve Implantation (TAVI) surgeon in Mumbai, experience, infrastructure, and coordinated heart team assessment are critical."
            subIntro="Heart Valve Experts offers:"
            bulletPoints={[
              "Experience of 1000+ Transcatheter Aortic Valve Implantation (TAVI) procedures",
              "Doctors with highest numbers of Transcatheter Aortic Valve Implantation (TAVI) procedures in Mumbai",
      ...
      <Doctors
        title="Meet Our Transcatheter Aortic Valve Implantation (TAVI) Specialists in Mumbai"
        des="Transcatheter Aortic Valve Implantation (TAVI) and structural heart procedures are performed by experienced interventional cardiologists and cardiac specialists, including:"
      />
      <TaviSection
        imageSrc="/images/service/TAVI/1.webp"
        ...
        description={[
          ...
          "For many patients, Transcatheter Aortic Valve Implantation (TAVI) surgery in Mumbai provides an effective alternative to open surgical valve replacement.",
        ]}
        buttonText="Request a Consultation"
      />
      <FollowUpSection
        tag="Who it’s For"
        title="Who is Eligible for Transcatheter Aortic Valve Implantation (TAVI) Surgery in Mumbai?"
        intro="Transcatheter Aortic Valve Implantation (TAVI) surgery in Mumbai is typically recommended for patients with:"
        subIntro=""
        bulletPoints={[
        ...
        conclusion="Patients undergo detailed imaging and heart team evaluation before being considered for the Transcatheter Aortic Valve Implantation (TAVI) procedure in Maharashtra."
        buttonText="Request a Consultation"
            ...
            procedures={[
              {
                ...
                description:
                  "Before proceeding with the Transcatheter Aortic Valve Implantation (TAVI) procedure in Mumbai, patients undergo:",
      ...
      <FollowUpSection
        tag="About"
        title="Transcatheter Aortic Valve Implantation (TAVI) Cost in Mumbai"
        intro="The cost of Transcatheter Aortic Valve Implantation (TAVI) in Mumbai generally ranges between ₹14 lakhs to ₹25 lakhs, depending on:"
        subIntro=""
        bulletPoints={[
          "Valve type used",
          "ICU stay duration",
        ...
        imageAlt="Transcatheter Aortic Valve Implantation (TAVI) Cost in Mumbai"
      />
      ...
      <AppointmentCTAMumbai
        ...
        heading="Schedule a Consultation for Transcatheter Aortic Valve Implantation (TAVI) in Mumbai"
        badgeText="If you or a loved one has severe aortic stenosis, early evaluation for Transcatheter Aortic Valve Implantation (TAVI) in Mumbai is important."
