...
export const metadata = {
  title: "Transcatheter Mitral Valve Repair (TMVR) Surgery in Mumbai | Transcatheter Mitral Valve Repair (TMVR) Procedure Mumbai",
  description:
    "Get advanced Transcatheter Mitral Valve Repair (TMVR) surgery in Mumbai at Heart Valve Experts. Minimally invasive valve replacement with expert care and cutting-edge cardiac technology.",
  alternates: {
...
const conditionsData = [
  ...
  },
  {
    ...
    desc: "Patients with severe backflow of blood or a failing surgical mitral valve prosthesis may need valve-in-valve Transcatheter Mitral Valve Repair (TMVR)",
  },
];

const delayRiskData = {
  heading: "Outcomes of Procedure Delay",
  title: "Risks of Delay of Transcatheter Mitral Valve Repair (TMVR) Surgery/Procedure",
  risks: [
    {
    ...
    {
      title: "Reduced candidacy for Transcatheter Mitral Valve Repair (TMVR)",
      description:
        "Anatomical changes may make minimally invasive Transcatheter Mitral Valve Repair (TMVR) surgery/procedure no longer viable.",
    },
    {
...
const timelineData = [
  ...
  {
    title: "Day 2",
    desc: "Transcatheter Mitral Valve Repair (TMVR) procedure performed via catheter approach through the femoral vein, often under conscious sedation",
...
const benefitsData2 = [
  {
    ...
    title: "Leading Transcatheter Mitral Valve Repair (TMVR) Specialists",
    desc: "Our Transcatheter Mitral Valve Repair (TMVR) specialists in Mumbai have extensive experience handling complex and high-risk Transcatheter Mitral Valve Repair (TMVR) cases.",
  },
  {
  ...
  },
  {
    ...
    title: "Comprehensive Transcatheter Mitral Valve Repair (TMVR) Valve Clinic",
  ...
  },
  {
    ...
    title: "Affordable Transcatheter Mitral Valve Repair (TMVR) in Mumbai",
  ...
  },
  {
    ...
    desc: "Our outcomes and care make us a go-to center for those seeking the best Transcatheter Mitral Valve Repair (TMVR) surgeon/operator in Mumbai.",
  },
];
...
const faqData = [
  {
    id: 1,
    question: "Is Transcatheter Mitral Valve Repair (TMVR) a surgery?",
    answer:
      "No, the Transcatheter Mitral Valve Repair (TMVR) procedure is not traditional open-heart surgery. It’s a minimally invasive, catheter-based treatment procedure that replaces the mitral valve without large incisions or the use of a heart-lung machine.",
  },
  {
    id: 2,
    question: "What is the cost of Transcatheter Mitral Valve Repair (TMVR) surgery/procedure in India?",
    answer:
      "The cost of Transcatheter Mitral Valve Repair (TMVR) in India typically ranges from ₹14–25 lakh in leading private hospitals. In selected centers or with our assistance programs, the cost may start from ₹10–15 lakh, depending on valve type and patient condition.",
  },
  {
    id: 3,
    question: "What is the success rate of Transcatheter Mitral Valve Repair (TMVR)?",
    answer:
      "Success rates for Transcatheter Mitral Valve Repair (TMVR) surgery/procedure in Mumbai are high when performed by experienced specialists. Most patients see significant improvement in heart function and quality of life.",
  },
  {
    id: 4,
    question: "What is the difference between TAVR and Transcatheter Mitral Valve Repair (TMVR)?",
    answer:
      "TAVR replaces the aortic valve; Transcatheter Mitral Valve Repair (TMVR) replaces the mitral valve. Both are catheter-based, minimally invasive procedures, but they treat different valves with different anatomical and procedural approaches.",
  },
  {
    id: 5,
    question: "How long is the ICU stay after mitral valve replacement?",
    answer:
      "For patients undergoing Transcatheter Mitral Valve Repair (TMVR) in Mumbai, ICU monitoring is usually required for 24–48 hours depending on patient stability.",
  },
  {
    id: 6,
    question: "Who is an ideal candidate for Transcatheter Mitral Valve Repair (TMVR)?",
    answer:
      "Patients with severe mitral regurgitation who are at high-risk for open surgery may be suitable for Transcatheter Mitral Valve Repair (TMVR) in Mumbai.",
  },
  {
    id: 7,
    question: "How long does the Transcatheter Mitral Valve Repair (TMVR) procedure take?",
    answer:
      "The Transcatheter Mitral Valve Repair (TMVR) surgery/procedure usually takes 1.5 to 3 hours, depending on patient complexity.",
  },
];
const serviceSchema = {
  ...
  description:
    "Transcatheter Mitral Valve Repair (TMVR) is a minimally invasive procedure that replaces a diseased mitral valve via catheter, without open-heart surgery.",
  ...
  preparation:
    "Before Transcatheter Mitral Valve Repair (TMVR), patients undergo imaging tests such as echocardiogram and CT scan, blood tests, and risk assessment to confirm suitability for the procedure.",
  followup:
    "After Transcatheter Mitral Valve Repair (TMVR), patients stay in the hospital for monitoring, receive medications, and undergo follow-up imaging and cardiology check-ups to assess valve function.",
...
const servciepage = () => {
  return (
    <div>
      ...
      />
      <BreadCrumb
        title="Transcatheter Mitral Valve Repair (TMVR) Surgery/Procedure"
        subpage="false"
      ...
      <TaviBenefits
        ...
        sectionLabel="Benefits of Transcatheter Mitral Valve Repair (TMVR)"
        heading="What are the Benefits of Transcatheter Mitral Valve Repair (TMVR) Surgery/Procedure?"
      ...
      <section className="animate-gradient-circle text-white relative overflow-hidden">
        ...
        <FollowUpSection
          ...
          title="Valve-in-Valve (ViV) Transcatheter Mitral Valve Repair (TMVR)"
          ...
          subIntro="When this happens, Valve-in-Valve Transcatheter Mitral Valve Repair (TMVR) offers a minimally invasive alternative to repeat open-heart surgery. Instead of replacing the old valve entirely, a new transcatheter valve is placed inside the existing one."
          bulletPoints={[
