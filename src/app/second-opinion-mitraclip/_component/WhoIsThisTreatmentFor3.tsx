  ...
  return (
    <section className="py-12 md:pb-20 ">
      <div className="max-w-7xl mx-auto px-3 ">
        ...
        {/* Content */}
        <div className="grid grid-cols-1 lg:grid-cols-[42%_55%] gap-8 lg:gap-14 items-start">
          {/* Left Image */}
          ...
          <div>
            ...
            <ul className="space-y-4  mb-2">
              {bullets.map((item, key) => (
                <li key={item.id} className="flex h-fit px-2 pr-4 lg:px-3 lg:pr-5 py-1 rounded-2xl items-start">
                  <span className="w-5 h-5 lg:w-6 lg:h-6 text-blue-400 rounded-full shrink-0">
                    {key + 1}.
                  </span>
                  <div>
