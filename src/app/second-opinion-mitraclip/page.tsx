...
const page = () => {
  const faqData = [
    {
      id: 1,
      question:
        "Is a second opinion appropriate for every patient advised valve surgery?",
      answer:
    ...
    },
    {
      id: 3,
      question:
        "How do I know if I am suitable for a minimally invasive valve procedure?",
      answer:
  ...
  const ctaData = {
    ...
    description2: "No obligation. Evidence-based. Patient-first.",
    ...
    <>
      ...
      <WhoIsThisTreatmentFor
        ...
        bullets={[
          {
            id: 1,
            text: "Independent review of all existing reports and imaging",
          },
          { id: 2, text: "Advanced 3D echo and CT analysis if required" },
          {
            id: 3,
            text: "Honest assessment surgery recommended only when truly necessary",
          },
