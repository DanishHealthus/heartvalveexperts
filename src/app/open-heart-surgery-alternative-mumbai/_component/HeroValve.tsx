...
const HeroValve = () => {
  return (
    <section
      id="book-appointment"
      className="pb-10 w-full animate-gradient-circle-aalekh text-white landing-main-font"
    >
      {/* Header */}
      <header className="flex items-center gap-4 justify-between px-3 md:px-12 xl:px-16 2xl:px-24 py-2 border-b border-white/30">
        ...
        <Link href={"#book-appointment"}>
          <button className="flex text-sm md:text-base items-center gap-2 cursor-pointer px-5 py-3 border-2 border-white rounded-full hover:bg-white hover:text-black transition duration-500 ease-in-out">
            Book Appointment
