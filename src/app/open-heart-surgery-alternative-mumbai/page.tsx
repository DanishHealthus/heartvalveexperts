...
const page = () => {
  const faqData = [
    ...
    },
    {
      id: 7,
      question:
        "Will I need to undergo multiple tests before deciding on the treatment?",
      answer:
    ...
    <>
      ...
      <WhoIsThisTreatmentFor
        ...
        bullets={[
          ...
          {
            id: 3,
            text: "Are at higher surgical risk due to age or medical conditions",
          },
          { id: 4, text: "Have had previous bypass or valve surgery" },
          {
            id: 5,
            text: "Are seeking a second opinion on valve replacement options",
          },
        ]}
...
A specialist valve review helps determine the most appropriate treatment pathway.`}
          options={[
            ...
            },
            {
              ...
              subtitle: "For narrowed heart valves",
              description:
            ...
            },
            {
              ...
              subtitle: "For tricuspid valve regurgitation",
              description:
        ...
        steps={[
          {
            ...
            description: "Review of diagnosis, symptoms, and prior reports.",
          },
          {
            id: 2,
