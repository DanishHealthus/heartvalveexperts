...
export default function TaviSectionAll({
    imageSrc,
    imageAlt,
    imageTitle,
    tag,
                    ...
                    {buttonText && (
                        <div className="pt-4 flex justify-start">
                            <Link href="/contact-us">
                                <button className="flex cursor-pointer items-center gap-2 px-5 py-2 border-2 border-gray-400 rounded-full hover:bg-white hover:text-black transition duration-500 ease-in-out">
                                    {buttonText}
                                </button>
                            </Link>
                        </div>
